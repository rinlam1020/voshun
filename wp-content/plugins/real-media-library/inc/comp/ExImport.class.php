...
class ExImport extends base\Base {
    ...
    public function html_rml_button_export() { 
        echo '<button class="rml-rest-button button button-primary" data-url="export" data-method="GET">' . __('Export', RML_TD) . '</button>
        <button class="rml-rest-button button" data-url="import" data-method="POST">' . __('Import', RML_TD) . '</button>
    ...
    public function html_rml_button_import_cats() {
        foreach ($this->getHierarchicalTaxos() as $tax) {
            echo '<button class="rml-rest-button button" data-url="import/taxonomy" data-method="POST" data-taxonomy="' . esc_attr($tax) . '">' . __('Import', RML_TD) . ' \'' . $tax . '\'</button>
