<?php
    ...
    /**
     * ReduxSA Framework Instance Container Class
     * Automatically captures and stores all instances
     * of ReduxSAFramework at instantiation.
     *
     * @package     ReduxSA_Framework
     * @subpackage  Core
     */
    class ReduxSAFrameworkInstances {

        /**
         * ReduxSAFrameworkInstances
         *
         * @var object
         */
        ...
        /**
         * Get Instance
         * Get ReduxSAFrameworkInstances instance
         * OR an instance of ReduxSAFramework by [opt_name]
         *
        ...
        /**
         * Get all instantiated ReduxSAFramework instances (so far)
         *
        ...
        private function __construct() {
            ...
            add_action( 'reduxsa/construct', array( $this, 'capture' ), 5, 1 );
            ...
            if (!class_exists('ReduxSA_Tracking') || !method_exists('ReduxSA_Tracking', 'trackingObject')) {
        ...
        function support_args() {
            ...
            if ( isset( $_REQUEST['i'] ) && ! empty( $_REQUEST['i'] ) ) {
                ...
                $array = ReduxSA_Helpers::trackingObject();
                if ( is_array( $instances ) && ! empty( $instances ) ) {
        ...
        function capture( $ReduxSAFramework ) {
            $this->store( $ReduxSAFramework );
        }

        private function store( $ReduxSAFramework ) {
            if ( $ReduxSAFramework instanceof ReduxSAFramework ) {
                $key                     = $ReduxSAFramework->args['opt_name'];
                self::$instances[ $key ] = $ReduxSAFramework;
            }
        }
    }
