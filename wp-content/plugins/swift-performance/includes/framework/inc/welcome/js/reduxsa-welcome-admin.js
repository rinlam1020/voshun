(function( $ ) {
    ...
    $.reduxsa_welcome = $.reduxsa_welcome || {};

    $( document ).ready(
        function() {
            $.reduxsa_welcome.initQtip();
            if ( jQuery( document.getElementById( "support_div" ) ).is( ":visible" ) ) {
                $.reduxsa_welcome.initSupportPage();
            }
            $.reduxsa_welcome.supportHash();
        }
    );


    $.reduxsa_welcome.supportHash = function() {
        ...
        jQuery( '.reduxsa_support_hash' ).click(
            function( e ) {
                ...
                var $nonce = jQuery( '#reduxsa_support_nonce' ).val();
                ...
                jQuery.ajax(
                    {
                        ...
                        success: function( response ) {
                            if ( response.status == "success" ) {
                                jQuery( '#support_hash' ).val( 'http://support.reduxsa.io/?id=' + response.identifier );
    ...
    $.reduxsa_welcome.initSupportPage = function() {
        //jQuery time
    ...
    $.reduxsa_welcome.initQtip = function() {
        if ( $().qtip ) {
