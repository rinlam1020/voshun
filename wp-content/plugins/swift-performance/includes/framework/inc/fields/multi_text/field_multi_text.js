...
(function( $ ) {
    ...
    reduxsa.field_objects.multi_text = reduxsa.field_objects.multi_text || {};

    reduxsa.field_objects.multi_text.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.reduxsa-container-multi_text:visible' );
        }
        ...
        $( selector ).each(
            function() {
                ...
                el.find( '.reduxsa-multi-text-remove' ).live(
                    'click', function() {
                        reduxsa_change( $( this ) );
                        ...
                        $( this ).parent().slideUp(
                            'medium', function() {
                                ...
                                if (lis == 1) {
                                    var add = el.find( '.reduxsa-multi-text-add' );
                ...
                el.find( '.reduxsa-multi-text-add' ).click(
                    function() {
