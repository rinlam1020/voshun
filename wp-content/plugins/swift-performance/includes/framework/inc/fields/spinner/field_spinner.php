...
if ( ! class_exists( 'ReduxSAFramework_spinner' ) ) {
    class ReduxSAFramework_spinner {
        ...
        function render() {
            ...
            echo '<div id="' . $this->field['id'] . '-spinner" class="reduxsa_spinner" rel="' . $this->field['id'] . '">';
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                'reduxsa-field-spinner-custom-js',
                ReduxSAFramework::$_url . 'inc/fields/spinner/vendor/spinner_custom.js',
            ...
            wp_enqueue_script(
                'reduxsa-field-spinner-js',
                ReduxSAFramework::$_url . 'inc/fields/spinner/field_spinner' . ReduxSA_Functions::isMin() . '.js',
                array(
                    'jquery',
                    'reduxsa-field-spinner-custom-js',
                    'jquery-ui-core',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-spinner-css',
                    ReduxSAFramework::$_url . 'inc/fields/spinner/field_spinner.css',
                    array(),
                    time(),
                    'all'
                );
