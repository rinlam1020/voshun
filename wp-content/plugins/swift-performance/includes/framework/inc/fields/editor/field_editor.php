...
// Don't duplicate me!
if ( ! class_exists( 'ReduxSAFramework_editor' ) ) {

    /**
     * Main ReduxSAFramework_editor class
     *
     * @since       1.0.0
     */
    class ReduxSAFramework_editor {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-editor-css',
                    ReduxSAFramework::$_url . 'inc/fields/editor/field_editor.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'reduxsa-field-editor-js',
                ReduxSAFramework::$_url . 'inc/fields/editor/field_editor' . ReduxSA_Functions::isMin() . '.js',
