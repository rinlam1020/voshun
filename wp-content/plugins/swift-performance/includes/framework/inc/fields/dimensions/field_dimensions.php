<?php
    ...
    if ( ! class_exists( 'ReduxSAFramework_dimensions' ) ) {
        class ReduxSAFramework_dimensions {
            ...
            function render() {
                ...
                echo '<fieldset id="' . $this->field['id'] . '" class="reduxsa-dimensions-container" data-id="' . $this->field['id'] . '">';
                ...
                if ( $this->field['width'] === true ) {
                    ...
                    echo '<input type="text" class="reduxsa-dimensions-input reduxsa-dimensions-width mini ' . $this->field['class'] . '" placeholder="' . __( 'Width', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-width" value="' . filter_var( $this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( $this->field['height'] === true ) {
                    ...
                    echo '<input type="text" class="reduxsa-dimensions-input reduxsa-dimensions-height mini ' . $this->field['class'] . '" placeholder="' . __( 'Height', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-height" value="' . filter_var( $this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
                    echo '<div class="select_wrapper dimensions-units" original-title="' . __( 'Units', 'reduxsa-framework' ) . '">';
                    echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __( 'Units', 'reduxsa-framework' ) . '" class="reduxsa-dimensions reduxsa-dimensions-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'reduxsa-field-dimensions-js',
                    ReduxSAFramework::$_url . 'inc/fields/dimensions/field_dimensions' . ReduxSA_Functions::isMin() . '.js',
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'reduxsa-field-dimensions-css',
                        ReduxSAFramework::$_url . 'inc/fields/dimensions/field_dimensions.css',
                        array(),
                        time(),
                        'all'
                    );
