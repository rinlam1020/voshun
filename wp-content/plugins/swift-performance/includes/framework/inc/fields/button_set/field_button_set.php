...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxSAFramework_button_set' ) ) {

        /**
         * Main ReduxSAFramework_button_set class
         *
         * @since       1.0.0
         */
        class ReduxSAFramework_button_set {
            ...
            public function enqueue() {
                ...
                if (!wp_script_is ( 'reduxsa-field-button-set-js' )) {
                    wp_enqueue_script(
                        'reduxsa-field-button-set-js',
                        ReduxSAFramework::$_url . 'inc/fields/button_set/field_button_set' . ReduxSA_Functions::isMin() . '.js',
                        array( 'jquery', 'jquery-ui-core', 'reduxsa-js' ),
                        time(),
                        true
                    );
                }
