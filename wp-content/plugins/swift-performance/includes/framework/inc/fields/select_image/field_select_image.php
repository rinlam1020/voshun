...
if ( ! class_exists( 'ReduxSAFramework_select_image' ) ) {
    class ReduxSAFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="reduxsa-select-item reduxsa-select-images ' . $this->field['class'] . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                if ( '' == $this->value ) {
                    echo '<img src="#" class="reduxsa-preview-image" style="visibility:hidden;" id="image_' . $this->field['id'] . '">';
                } else {
                    echo '<img src=' . $this->field['options'][ $arrNum - 1 ]['img'] . ' class="reduxsa-preview-image" id="image_' . $this->field['id'] . '">';
                }
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ReduxSAFramework::$_url . 'inc/fields/select_image/field_select_image' . ReduxSA_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-select-image-css',
                    ReduxSAFramework::$_url . 'inc/fields/select_image/field_select_image.css',
                    array(),
                    time(),
                    'all'
                );
