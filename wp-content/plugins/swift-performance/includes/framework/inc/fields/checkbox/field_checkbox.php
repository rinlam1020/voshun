    ...
    class ReduxSAFramework_checkbox {
        ...
        public function render () {
            ...
            if ( !empty ( $this->field[ 'options' ] ) && ( is_array ( $this->field[ 'options' ] ) || is_array ( $this->field[ 'default' ] ) ) ) {
                ...
                if (count($this->field[ 'options' ]) > 1){
                      echo '<li><a href="javascript:void(0);" class="button button-primary reduxsa-toggle-all">'.esc_html__('Toggle All', 'swift-performance').'</a><li>';
                }
