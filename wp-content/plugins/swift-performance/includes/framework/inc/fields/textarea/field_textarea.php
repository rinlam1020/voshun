<?php
     ...
     * @link        http://reduxsaframework.com
     * @method      Test
...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxSAFramework_textarea' ) ) {
        class ReduxSAFramework_textarea {

            /**
             * Field Constructor.
             *
             * @param       $value  Constructed by ReduxSA class. Based on the passing in $field['defaults'] value and what is stored in the database.
             * @param       $parent ReduxSAFramework object is passed for easier pointing.
             *
            ...
            function render() {
                ...
                // The $this->field variables are already escaped in the ReduxSAFramework Class.
                ?>
