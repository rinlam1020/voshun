...
if ( ! class_exists( 'ReduxSAFramework_select' ) ) {
    class ReduxSAFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
                ...
                if ( $this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive" ) {
                    ...
                    /**
                     * filter 'reduxsa-font-icons-file}'
                     *
                    ...
                    /**
                     * filter 'reduxsa/{opt_name}/field/font/icons/file'
                     *
                     * @param  array $icon_file File for the icons
                     */
                    $icons_file = apply_filters( "reduxsa/{$this->parent->args['opt_name']}/field/font/icons/file", $icons_file );
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'reduxsa-framework' );
                ...
                echo '<select ' . $multi . ' id="' . $this->field['id'] . '-select" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . $nameBrackets . '" class="reduxsa-select-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'reduxsa-framework' ) . '</strong>';
            }
        } //function
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'reduxsa-field-select-js',
                ReduxSAFramework::$_url . 'inc/fields/select/field_select' . ReduxSA_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-select-css',
                    ReduxSAFramework::$_url . 'inc/fields/select/field_select.css',
                    array(),
                    time(),
                    'all'
                );
