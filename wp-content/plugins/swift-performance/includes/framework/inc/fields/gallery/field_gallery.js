...
(function( $ ) {
    ...
    reduxsa.field_objects.gallery = reduxsa.field_objects.gallery || {};

    $( document ).ready(
        function() {
            //reduxsa.field_objects.gallery.init();
        }
    );

    reduxsa.field_objects.gallery.init = function( selector ) {


        if ( !selector ) {
            selector = $( document ).find( '.reduxsa-container-gallery:visible' );
        }
                                ...
                                'update', function( selection ) {
                                    ...
                                    var ids = selection.models.map(
                                        function( e ) {
                                            ...
                                            preview_html = "<a class='of-uploaded-image' href='" + preview_img + "'><img class='reduxsa-option-image' src='" + preview_img + "' alt='' /></a>";
                                    ...
                                    reduxsa_change( current_gallery.find( '.gallery_values' ) );
