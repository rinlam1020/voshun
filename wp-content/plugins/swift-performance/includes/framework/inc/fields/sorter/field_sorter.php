...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxSAFramework_sorter' ) ) {
        class ReduxSAFramework_sorter {

            /**
             * Field Constructor.
             * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
             *
             * @since ReduxSA_Options 1.0.0
             */
            ...
            function render() {
                ...
                if ( is_array( $sortlists ) ) {
                    ...
                    if ( $sortlists ) {
                        echo '<fieldset id="' . esc_attr($this->field['id']) . '" class="reduxsa-sorter-container reduxsa-sorter">';
            ...
            function enqueue() {
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'reduxsa-field-sorder-css',
                        ReduxSAFramework::$_url . 'inc/fields/sorter/field_sorter.css',
                        array(),
                        time(),
                        'all'
                    );
                ...
                wp_enqueue_script(
                    'reduxsa-field-sorter-js',
                    ReduxSAFramework::$_url . 'inc/fields/sorter/field_sorter' . ReduxSA_Functions::isMin() . '.js',
                    array( 'jquery', 'reduxsa-js', 'jquery-ui-sortable' ),
                    time(),
                    true
                );
            }
