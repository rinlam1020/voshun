...
// Don't duplicate me!
if ( ! class_exists( 'ReduxSAFramework_link_color' ) ) {

    /**
     * Main ReduxSAFramework_link_color class
     *
     * @since       1.0.0
     */
    class ReduxSAFramework_link_color {
        ...
        public function render() {
            ...
            if ( $this->field['regular'] === true && $this->field['default']['regular'] !== false ) {
                echo '<span class="linkColor"><strong>' . __( 'Regular', 'reduxsa-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-regular" name="' . $this->field['name'] . $this->field['name_suffix'] . '[regular]' . '" value="' . $this->value['regular'] . '" class="reduxsa-color reduxsa-color-regular reduxsa-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['regular'] . '" /></span>';
            }

            if ( $this->field['hover'] === true && $this->field['default']['hover'] !== false ) {
                echo '<span class="linkColor"><strong>' . __( 'Hover', 'reduxsa-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . $this->field['name_suffix'] . '[hover]' . '" value="' . $this->value['hover'] . '" class="reduxsa-color reduxsa-color-hover reduxsa-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['hover'] . '" /></span>';
            }

            if ( $this->field['visited'] === true && $this->field['default']['visited'] !== false ) {
                echo '<span class="linkColor"><strong>' . __( 'Visited', 'reduxsa-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . $this->field['name_suffix'] . '[visited]' . '" value="' . $this->value['visited'] . '" class="reduxsa-color reduxsa-color-visited reduxsa-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['visited'] . '" /></span>';
            }

            if ( $this->field['active'] === true && $this->field['default']['active'] !== false ) {
                echo '<span class="linkColor"><strong>' . __( 'Active', 'reduxsa-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-active" name="' . $this->field['name'] . $this->field['name_suffix'] . '[active]' . '" value="' . $this->value['active'] . '" class="reduxsa-color reduxsa-color-active reduxsa-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['active'] . '" /></span>';
            }
        }
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'reduxsa-field-link-color-js',
                ReduxSAFramework::$_url . 'inc/fields/link_color/field_link_color' . ReduxSA_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                wp_enqueue_style(
                    'reduxsa-field-link_color-js',
                    ReduxSAFramework::$_url . 'inc/fields/link_color/field_link_color.css',
                    array(),
                    time(),
                    'all'
                );
