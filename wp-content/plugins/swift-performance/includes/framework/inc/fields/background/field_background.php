...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxSAFramework_background' ) ) {

        /**
         * Main ReduxSAFramework_background class
         *
         * @since       3.1.5
         */
        class ReduxSAFramework_background {
            ...
            public function render() {
                ...
                if ( $this->field['background-color'] === true ) {
                    ...
                    echo '<input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-color]" id="' . $this->field['id'] . '-color" class="reduxsa-color reduxsa-background-input reduxsa-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['background-color'] . '"  data-default-color="' . ( isset( $this->field['default']['background-color'] ) ? $this->field['default']['background-color'] : "" ) . '" />';
                    ...
                    if ( ! isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                        ...
                        echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency reduxsa-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="' . $this->field['id'] . '-color" value="1"' . $tChecked . '> ' . __( 'Transparent', 'reduxsa-framework' ) . '</label>';
                    }
                ...
                if ( $this->field['background-repeat'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Repeat', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-repeat]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-repeat ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-clip'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Clip', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-clip]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-clip ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-origin'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Origin', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-origin]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-origin ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-size'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Size', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-size]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-size ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-attachment'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-attachment-select" data-placeholder="' . __( 'Background Attachment', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-attachment]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-attachment ' . $this->field['class'] . '">';
                    echo '<option></option>';
                    foreach ( $array as $k => $v ) {
                ...
                if ( $this->field['background-position'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-position-select" data-placeholder="' . __( 'Background Position', 'reduxsa-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-position]" class="reduxsa-select-item reduxsa-background-input reduxsa-background-position ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    $placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : __( 'No media selected', 'reduxsa-framework' );

                    echo '<input placeholder="' . $placeholder . '" type="text" class="reduxsa-background-input ' . $hide . 'upload ' . $this->field['class'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-image]" id="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][background-image]" value="' . $this->value['background-image'] . '" />';
                    ...
                    echo '<img class="reduxsa-option-image" id="image_' . $this->value['media']['id'] . '" src="' . $this->value['media']['thumbnail'] . '" alt="" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';
                    ...
                    echo '<span class="button reduxsa-background-upload" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'reduxsa-framework' ) . '</span>';
                    ...
                    echo '<span class="button removeCSS reduxsa-remove-background' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'reduxsa-framework' ) . '</span>';
            ...
            public function enqueue() {
                ...
                if (!wp_script_is ( 'reduxsa-field-background-js' )) {
                    wp_enqueue_script(
                        'reduxsa-field-background-js',
                        ReduxSAFramework::$_url . 'inc/fields/background/field_background' . ReduxSA_Functions::isMin() . '.js',
                ...
                if ($this->parent->args['dev_mode']) {
                    if (!wp_style_is ( 'reduxsa-field-background-css' )) {
                        wp_enqueue_style(
                            'reduxsa-field-background-css',
                            ReduxSAFramework::$_url . 'inc/fields/background/field_background.css',
                            array(),
                            time(),
                            'all'
                        );
