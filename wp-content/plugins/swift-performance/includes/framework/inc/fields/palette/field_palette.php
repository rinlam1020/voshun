...
if ( ! class_exists( 'ReduxSAFramework_palette' ) ) {
    class ReduxSAFramework_palette {
        ...
        public function render() {
            ...
            foreach ( $this->field['palettes'] as $value => $colorSet ) {
                ...
                echo '<input type="radio" value="' . $value . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="reduxsa-palette-set ' . $this->field['class'] . '" id="' . $this->field['id'] . '-' . $value . '"' . $checked . '>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'reduxsa-field-palette-js',
                ReduxSAFramework::$_url . 'inc/fields/palette/field_palette' . $min . '.js',
                array( 'jquery', 'reduxsa-js', 'jquery-ui-button', 'jquery-ui-core' ),
                time(),
                true
            );  
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-palette-css',
                    ReduxSAFramework::$_url . 'inc/fields/palette/field_palette.css',
                    array(),
                    time(),
                    'all'
                );
