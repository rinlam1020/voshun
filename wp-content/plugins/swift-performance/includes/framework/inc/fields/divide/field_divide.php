...
// Don't duplicate me!
if ( !class_exists ( 'ReduxSAFramework_divide' ) ) {

    /**
     * Main ReduxSAFramework_divide class
     *
     * @since       1.0.0
     */
    class ReduxSAFramework_divide {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-divide',
                    ReduxSAFramework::$_url . 'inc/fields/divide/field_divide.css',
                    array(),
                    time(),
                    'all'
                );
