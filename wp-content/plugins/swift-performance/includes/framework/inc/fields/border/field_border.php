...
// Don't duplicate me!
if ( ! class_exists( 'ReduxSAFramework_border' ) ) {
    
    class ReduxSAFramework_border {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="reduxsa-border-all reduxsa-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'All', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
            }

            echo '<input type="hidden" class="reduxsa-border-value" id="' . $this->field['id'] . '-top" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-top]" value="' . ( isset($this->value['top']) && $this->value['top'] != '' ? $this->value['top'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduxsa-border-value" id="' . $this->field['id'] . '-right" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-right]" value="' . ( isset($this->value['right']) && $this->value['right'] != '' ? $this->value['right'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduxsa-border-value" id="' . $this->field['id'] . '-bottom" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-bottom]" value="' . ( isset($this->value['bottom']) && $this->value['bottom'] != '' ? $this->value['bottom'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduxsa-border-value" id="' . $this->field['id'] . '-left" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-left]" value="' . ( isset($this->value['left']) && $this->value['left'] != '' ? $this->value['left'] . 'px' : '' ) . '">';
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                ...
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="reduxsa-border-top reduxsa-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Top', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
                }
                ...
                if ( $this->field['right'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="reduxsa-border-right reduxsa-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Right', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
                }
                ...
                if ( $this->field['bottom'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="reduxsa-border-bottom reduxsa-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
                }
                ...
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="reduxsa-border-left reduxsa-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'reduxsa-framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
                }
            }
            ...
            if ( $this->field['style'] != false ) {
                ...
                echo '<select original-title="' . __( 'Border style', 'reduxsa-framework' ) . '" id="' . $this->field['id'] . '[border-style]" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-style]" class="tips reduxsa-border-style ' . $this->field['class'] . '" rows="6" data-id="' . $this->field['id'] . '">';
            ...
            if ( $this->field['color'] != false ) {
                ...
                echo '<input name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-color]" id="' . $this->field['id'] . '-border" class="reduxsa-border-color reduxsa-color reduxsa-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['color'] . '"  data-default-color="' . $default . '" data-id="' . $this->field['id'] . '" />';
            } else {
        ...
        function enqueue() {
            ...
            if (!wp_script_is ( 'reduxsa-field-border-js' )) {
                wp_enqueue_script(
                    'reduxsa-field-border-js',
                    ReduxSAFramework::$_url . 'inc/fields/border/field_border' . $min . '.js',
                    array( 'jquery', 'select2-js', 'wp-color-picker', 'reduxsa-js' ),
                    time(),
                    true
                );
            }
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                if (!wp_style_is ( 'reduxsa-field-border-css' )) {
                    wp_enqueue_style(
                        'reduxsa-field-border-css',
                        ReduxSAFramework::$_url . 'inc/fields/border/field_border.css',
                        array(),
                        time(),
                        'all'
                    );
