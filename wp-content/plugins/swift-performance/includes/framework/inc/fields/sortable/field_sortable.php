...
if ( ! class_exists( 'ReduxSAFramework_sortable' ) ) {
    class ReduxSAFramework_sortable {

        /**
         * Field Constructor.
         * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
         *
         * @since ReduxSA_Options 2.0.1
         */
        ...
        function render() {
            ...
            echo '<ul id="' . $this->field['id'] . '-list" class="reduxsa-sortable ' . $class . ' ' . $label_class . '">';
        ...
        function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduxsa-field-sortable-css',
                    ReduxSAFramework::$_url . 'inc/fields/sortable/field_sortable.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'reduxsa-field-sortable-js',
                ReduxSAFramework::$_url . 'inc/fields/sortable/field_sortable' . ReduxSA_Functions::isMin() . '.js',
