<?php
    ...
    if ( ! class_exists( 'reduxsaNewsflash' ) ) {
        class reduxsaNewsflash {
            private $parent = null;
            private $notice_data = '';
            private $server_file = '';
            private $interval = 3;
            ...
            public function __construct( $parent, $params ) {
                ...
                $fname = ReduxSA_Functions::bub( 'get_notice_json', $parent->args['opt_name'] );
                $mname = ReduxSA_Functions::yo( 'display_message', $parent->args['opt_name'] );
                    ...
                    if ( $data != '' || ! empty( $data ) ) {
                        ...
                        if ( ! empty( $this->notice_data ) ) {
                            if ( strcmp( $data, $this->notice_data ) == 0 ) {
                                ...
                                ReduxSA_Functions::setCookie( $this->cookie_id, time(), time() + ( 86400 * $this->interval ), '/' );
            ...
            private function display_message() {
                ...
                if ( ! empty( $this->notice_data ) ) {
                    ...
                    if ( is_array( $data ) && ! empty( $data ) ) {
                        ...
                        if ( $data['type'] == 'reduxsa-message' ) {
                            $data['type'] = 'updated reduxsa-message';
                        }
