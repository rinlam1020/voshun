...
?>
<div class="reduxsa-sidebar">
    <ul class="reduxsa-group-menu">
<?php
        ...
        /**
         * action 'reduxsa-page-after-sections-menu-{opt_name}'
         *
         * @param object $this ReduxSAFramework
         */
        do_action ( "reduxsa-page-after-sections-menu-{$this->parent->args[ 'opt_name' ]}", $this );

        /**
         * action 'reduxsa/page/{opt_name}/menu/after'
         *
         * @param object $this ReduxSAFramework
         */
        do_action ( "reduxsa/page/{$this->parent->args[ 'opt_name' ]}/menu/after", $this );
?>
    </ul>
</div>